    ...
    def train(self, X_train, y_train, optimizer_tuning=False, override_best_params=False):
        ...
        if self.best_params is not None and not override_best_params:
            ...
            if optimizer_tuning:
                ...
                param_grid = {
                    'dnn__layer_sizes': [[180, 50], [250,80], [320, 60]],
                    'dnn__learning_rate': [0.001], #, 0.05, 0.1, 1],
                    'dnn__loss': ['binary_crossentropy', 'mean_squared_error'], #, 'logcosh', 'mean_squared_error',
                    #               'mean_squared_logarithmic_error'],
                    'dnn__batch_size': [10, 100],
                    'dnn__epochs': [20, 100, 500, 2000]
